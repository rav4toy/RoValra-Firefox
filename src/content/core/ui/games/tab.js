...
export function createTab({
    ...
    tab.innerHTML = safeHtml`<a class="rbx-tab-heading"><span class="text-lead">${label}</span></a>`;
    ...
    const init = () => {
        ...
        if (hasPaneWithBackground) {
            contentPane.style.backgroundColor =
        ...
        tab.addEventListener('click', (e) => {
            e.preventDefault();
            document
                .querySelectorAll('.rbx-tab.active, .tab-pane.active')
